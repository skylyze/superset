        ...
        if os.path.exists(superset_trans_file) and os.path.exists(local_trans_file):
            ...
            try:
                ...
                if "superset" in data["locale_data"]:
                    data["locale_data"]["superset"] = (
                        data["locale_data"]["superset"] | additional_content
                    )
...
def get_languages():
    ...
    languages = []
    if os.path.exists(path_to_ds_translations) and os.path.isdir(
        path_to_ds_translations
    ):
        ...
        for root, dirs, files in os.walk(path_to_ds_translations):
            ...
            for file_name in files:
                ...
                languages.append({"lang": lang, "path_to_local": file_path})
    return languages
